...
public class OrientationModule extends ReactContextBaseJavaModule implements LifecycleEventListener{
    ...
    public OrientationModule(ReactApplicationContext reactContext, final Activity _activity) {
        super(reactContext);
        ctx = reactContext;
        activity = _activity;
//        final ReactApplicationContext ctx = reactContext;
        Log.w("myApp","Orientation changed--11111-");
        receiver = new BroadcastReceiver() {
            @Override

            public void onReceive(Context context, Intent intent) {
                Log.w("myApp","Orientation changed--222222-");
                ...
                Log.w("myApp","Orientation changed--3333333-");
                if (ctx.hasActiveCatalystInstance()) {
                    Log.w("myApp","Orientation changed---");
                    ctx
